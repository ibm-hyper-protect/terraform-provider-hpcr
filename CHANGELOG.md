## <small>1.10.11 (2026-08-31)</small>

* fix(deps): update module github.com/ibm-hyper-protect/contract-go/v2 to v2.42.0 (#323) ([f380be7](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/f380be7)), closes [#323](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/323)
* chore(deps): update go dependencies (#321) ([69ac86a](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/69ac86a)), closes [#321](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/321)
* chore(deps): update softprops/action-gh-release digest to efb3536 (#322) ([a2903b6](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/a2903b6)), closes [softprops/action-#release](https://github.com/softprops/action-/issues/release) [#322](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/322)

## <small>1.10.10 (2026-08-27)</small>

* fix(deps): update go dependencies (#320) ([31c8a7c](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/31c8a7c)), closes [#320](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/320)
* chore(deps): update go dependencies (#319) ([39335e0](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/39335e0)), closes [#319](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/319)
* chore(deps): update module github.com/yuin/goldmark-meta/v2 to v2.0.1 (#317) ([418c6c1](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/418c6c1)), closes [#317](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/317)
* chore(deps): update module google.golang.org/grpc to v1.83.2 (#318) ([5af4a7f](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/5af4a7f)), closes [#318](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/318)

## <small>1.10.9 (2026-08-21)</small>

* fix(deps): update module github.com/ibm-hyper-protect/contract-go/v2 to v2.41.1 (#315) ([3b6ec4d](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/3b6ec4d)), closes [#315](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/315)
* chore(deps): update go dependencies (#316) ([a2fd687](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/a2fd687)), closes [#316](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/316)

## <small>1.10.8 (2026-08-20)</small>

* fix(deps): update go dependencies (#313) ([f2b875b](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/f2b875b)), closes [#313](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/313)
* chore(deps): update go dependencies (#314) ([0b4eed1](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/0b4eed1)), closes [#314](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/314)
...
* chore(deps): update actions/setup-go action to v7 (#268) ([1a2a9ce](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/1a2a9ce)), closes [#268](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/268)
* chore(deps): update module google.golang.org/grpc to v1.82.1 (#267) ([329ee44](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/329ee44)), closes [#267](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/267)

## <small>1.9.6 (2026-07-15)</small>

* fix(deps): update module github.com/ibm-hyper-protect/contract-go/v2 to v2.33.0 (#266) ([81343a6](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/81343a6)), closes [#266](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/266)

## <small>1.9.5 (2026-07-13)</small>

* fix(deps): update module github.com/ibm-hyper-protect/contract-go/v2 to v2.32.0 (#265) ([8a72268](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/8a72268)), closes [#265](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/265)
* chore(deps): update go dependencies (#263) ([47f240b](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/47f240b)), closes [#263](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/263)
* chore(deps): update go dependencies (#264) ([4619b7a](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/4619b7a)), closes [#264](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/264)
* chore(deps): update module github.com/yuin/goldmark to v1.8.4 (#262) ([2cb13f6](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/2cb13f6)), closes [#262](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/262)

## <small>1.9.4 (2026-07-09)</small>

* fix(deps): update go dependencies (#261) ([556d074](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/556d074)), closes [#261](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/261)
* chore(deps): update go dependencies (#260) ([21e9713](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/commit/21e9713)), closes [#260](https://github.com/ibm-hyper-protect/terraform-provider-hpcr/issues/260)
